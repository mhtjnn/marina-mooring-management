...
public class WorkOrderController extends GlobalExceptionHandler {
    ...
    @Operation(
            summary = "API to fetch work order by job type from the database",
            responses = {
                    @ApiResponse(
                            description = "Success",
                            content = { @Content(schema = @Schema(implementation = BasicRestResponse.class), mediaType = "application/json") },
    ...
    public BasicRestResponse fetchWorkOrderByJobType(
            @Parameter(description = "JobTypeId", schema = @Schema(implementation = Integer.class)) final @PathVariable("jobTypeId") Integer jobTypeId,
            @Parameter(description = "Page Number", schema = @Schema(implementation = Integer.class)) final @RequestParam(value = "pageNumber", defaultValue = DEFAULT_PAGE_NUM, required = false) Integer pageNumber,
            @Parameter(description = "Page Size", schema = @Schema(implementation = Integer.class)) final @RequestParam(value = "pageSize", defaultValue = DEFAULT_PAGE_SIZE, required = false) Integer pageSize,
            @Parameter(description = "Sort By(field)", schema = @Schema(implementation = String.class)) final @RequestParam(value = "sortBy", defaultValue = "id", required = false) String sortBy,
            @Parameter(description = "Sort Dir(asc --> ascending or des --> descending)", schema = @Schema(implementation = String.class)) final @RequestParam(value = "sortDir", defaultValue = "asc", required = false) String sortDir,
        ...
        final BaseSearchRequest baseSearchRequest = BaseSearchRequest.builder()
                ...
                .sortDir(sortDir)
                .build();
        return workOrderService.fetchWorkOrderByJobType(baseSearchRequest, jobTypeId, showCompletedWorkOrders, searchText, request);
    }

    @Operation(
            summary = "API to fetch work order by job location from the database",
            responses = {
                    @ApiResponse(
                            description = "Success",
                            content = { @Content(schema = @Schema(implementation = BasicRestResponse.class), mediaType = "application/json") },
    ...
    @GetMapping("/jobLocation/{jobLocationId}")
    public BasicRestResponse fetchWorkOrderByJobLocation(
            @Parameter(description = "JobLocationId", schema = @Schema(implementation = Integer.class)) final @PathVariable("jobLocationId") Integer jobLocationId,
            @Parameter(description = "Page Number", schema = @Schema(implementation = Integer.class)) final @RequestParam(value = "pageNumber", defaultValue = DEFAULT_PAGE_NUM, required = false) Integer pageNumber,
            @Parameter(description = "Page Size", schema = @Schema(implementation = Integer.class)) final @RequestParam(value = "pageSize", defaultValue = DEFAULT_PAGE_SIZE, required = false) Integer pageSize,
            @Parameter(description = "Sort By(field)", schema = @Schema(implementation = String.class)) final @RequestParam(value = "sortBy", defaultValue = "id", required = false) String sortBy,
            @Parameter(description = "Sort Dir(asc --> ascending or des --> descending)", schema = @Schema(implementation = String.class)) final @RequestParam(value = "sortDir", defaultValue = "asc", required = false) String sortDir,
        ...
        final BaseSearchRequest baseSearchRequest = BaseSearchRequest.builder()
                ...
                .sortDir(sortDir)
                .build();
        return workOrderService.fetchWorkOrderByJobLocation(baseSearchRequest, jobLocationId, showCompletedWorkOrders, searchText, request);
    }
