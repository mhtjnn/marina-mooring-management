...
public interface WorkOrderRepository extends JpaRepository<WorkOrder, Integer> {
    ...
    @Query("SELECT new com.marinamooringmanagement.model.entity.WorkOrder(" +
            "wo.id, wo.workOrderNumber, wo.creationDate, wo.dueDate, wo.scheduledDate, wo.completedDate, " +
            "wo.time, wo.problem, " +
            ...
            "s.id, s.serviceAreaName, s.gpsCoordinates, " +
            ...
            "LOWER(jt.type) LIKE LOWER(CONCAT('%', :searchText, '%')) OR " +
    ...
    List<WorkOrder> findAllWorkOrderWithOnlyJobType(@Param("userId") Integer userId,
                            @Param("showCompletedWorkOrders") String showCompletedWorkOrder);
    ...
    List<WorkOrder> findAllWorkOrderWithOnlyServiceArea(@Param("userId") Integer userId,
                                                    @Param("showCompletedWorkOrders") String showCompletedWorkOrder);
    ...
    List<WorkOrder> findAllWorkOrderByJobType(@Param("searchText") String searchText,
    ...
    List<WorkOrder> findAllWorkOrderByJobLocation(@Param("searchText") String searchText,
                                                  @Param("jobLocationId") Integer jobLocationId,
                                                  @Param("userId") Integer userId,
                                                  @Param("showCompletedWorkOrders") String showCompletedWorkOrders);
}
